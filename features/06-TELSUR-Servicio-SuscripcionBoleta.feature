Feature: Telsur contratacion de servicio
  ...
  Scenario Outline:
    ...
    Examples:
      ...
      | /plan-internet-600.html | LOS RIOS | VALDIVIA | INTENDENTE RICARDO OLEA SILVA | 979    | ELLIOT LEOPOLDO | 957544722 | test@test.com | Plan Internet 600 | Microsoft 365 Familia | Pago Mensual | 10774640-4 | 524810998 | TB1      | 4051-8856-0044-6623 | 123   | 11.111.111-1 |