...
#    When Se Valida el Envio de email.
    ...
    Examples:
      ...
      | https://mcstaging.tienda.gtd.cl/admin | sluis01 | Temporal01 | Plan Internet 600(GB1)                                  | GTD        | METROPOLITANA | LAS CONDES | CERRO PROVINCIA | 125    |              | Testing Balloon | 366288783 | 957544722 | luis.sandoval@balloon-group.com | Plan Internet 600                                 | Microsoft 365 Famil | XXXX  |
