Feature: Solicitud Servicio
  ...
  Scenario Outline: Solicitud Servicio "<TestCase>"
    ...
    Examples:
      ...
      | /plan-internet-600.html                                |       | METROPOLITANA | LAS CONDES | CERRO PROVINCIA | 125    | Testing Balloon | 957544722 | luis.sandoval@balloon-group.com | Plan Internet 600                                      | Microsoft 365 Familia | Pago Automático (PAT) | 366288783 | XXXX  | GTD-1    | 4051-8856-0044-6623 | 123   | 11.111.111-1 |
