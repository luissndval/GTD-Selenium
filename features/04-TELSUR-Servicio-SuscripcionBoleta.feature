...
#    When Se selecciona Calle , Numero , Depto: "<Calle>" , "<Numero>" ["<Depto>"]
    ...
    Examples:
      ...
      | https://mcstaging.tienda.telsur.cl/plan-internet-600.html                               | LOS RIOS | VALDIVIA   | CALLE NUEVA            | 465     | Testing Balloon | 957544722 | luis.sandoval@balloon-group.com | Plan Internet 600                                   | Microsoft 365 Familia | Pago Mensual | 14481689-7 | 520106799 | TEL-1    | 4051-8856-0044-6623 | 123   | 11.111.111-1 |       |
